...
class ServiceTypeController extends Controller
{
    public function index(){
        $data = ServiceType::orderby('number','asc')->orderby('id','desc')->get();
        return view('be.servicetype.index',compact('data'));
    }
    public function add(){
        return view('be.servicetype.create');
    }
    public function store(Request $request){
        ...
        $validated = $request->validate([
            ...
            'slug' => "required|unique:service_types,slug"
        ],$trans);
...
;
        ...
        return redirect()->route('be.servicetype.index');
    }
    public function edit($id){
        $data = ServiceType::find($id);
        return view('be.servicetype.edit',compact('data'));
    }
    public function update($id,Request $request){
        ...
        $validated = $request->validate([
            ...
            'img' => 'image|mimes:jpeg,png,jpg,gif,svg|max:2048',
            'file' => 'max:10240|mimes:zip,pdf,jpeg,png,jpg',
            'slug' => "required|unique:service_types,slug,$id,id"
        ],$trans);
