...
class PolicyController extends Controller
{
    public function index(){
        $data = Policy::orderby('number','asc')->orderby('id','desc')->get();
        return view('be.policy.index',compact('data'));
    }
    public function add(){
        return view('be.policy.create');
    }
    public function store(Request $request){
        ...
        return redirect()->route('be.policy.index');
    }

    public function edit($id){
        $data = Policy::find($id);
        return view('be.policy.edit',compact('data'));
    }
