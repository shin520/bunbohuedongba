...
class ServiceController extends Controller
{
    public function index(){
        $data = Service::orderby('number','asc')->orderby('id','desc')->get();
        return view('be.service.index',compact('data'));
    }
    public function add(){
        $parent = ServiceType::orderby('number','asc')->orderby('id','desc')->where('hideshow','1')->get();
        return view('be.service.create',compact('parent'));
    }
...
;
        ...
        return redirect()->route('be.service.index');
    }
    public function edit($id){
        $parent = ServiceType::orderby('number','asc')->orderby('id','desc')->where('hideshow','1')->get();
        $data = Service::find($id);
        return view('be.service.edit',compact('data','parent'));
    }
