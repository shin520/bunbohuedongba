...
<div class="card-body">
    ...
    <div class="row">
        <div class="col-md-12">
            <div id="branch_filter" class="dataTables_filter">
                <form action="{{ route('be.branch.index') }}" method="GET">
                   <div class="row">
                        <div class="col-md-6 mb-3">
                          <div class="form-group">
                            <input name="search" type="search" class="form-control" placeholder="Tìm chi nhánh" value="{{ $key_search ?? '' }}">
                          </div>
                        </div>
                        <div class="col-md-6 mb-3">
                          <div class="form-group">
    ...
    <div class="row">
        <div class="col-md-12">
            <table class="table text-center table-rp" id="branch">
                <thead>
                    <tr width="100%">
                ...
                <tbody>
                    ...
                    <tr class="tr_id_{{ $item->id }}">
                        ...
                        <td data-label="Thao tác">
                            @include('be.component.show_edit_btn',['model'=>'branch'])
                            @include('be.component.show_delete_btn',['model'=>'branch'])
                        </td>
                    </tr>
                    @endforeach
