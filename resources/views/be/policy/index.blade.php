        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0 font-size-18">CHÍNH SÁCH
                        <a href="{{ route('be.policy.add') }}" class="btn btn-primary new-custom"><i class="fa fa-plus"></i> Thêm</a>
                    </h4>
                    ...
                    <tbody>
                        @foreach ($data as $item)
                            <tr>
                                ...
                                <td>
                                    @include('be.component.show_edit_btn',['model'=>'policy'])
                                    @include('be.component.show_delete_btn',['model'=>'policy'])
                                </td>
                            </tr>
                        @endforeach
...
@endsection
@push('script')
    @include('be.component.js_model',['model'=>'policy'])
    @include('be.component.js_datatable',['model'=>'policy'])
@endpush
