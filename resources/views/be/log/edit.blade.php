...
@section('content')
    <div class="card-body">
        ...
        <form action="{{ route('be.posttype.update', $data->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="row">
                <div class="col-md-3">
                    <div class="row">
                        <div class="col-md-12 mb-3">
                            <div class="form-group">
                                <label for="">TÊN</label>
                                <input value="{{ old('name') ?? $data->name }}" type="text" class="form-control" name="name"
                                    id="name_new">
                            </div>
                        </div>
                        <div class="col-md-12 mb-3">
                    ...
                    <div class="row">
                        <div class="col-md-12 mb-3">
                            <div class="form-group">
                                ...
                                <textarea name="description" class="form-control" id="description_new" cols="30" rows="3">{{ $data->description }}</textarea>
                            </div>
                        </div>
                        <div class="col-md-12 mb-3">
                            <div class="form-group">
                                <label for="">NỘI DUNG</label>
                                <textarea id="elm1" name="content" class="form-control" >{!! $data->content !!}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
