...
@section('content')
    <div class="card-body">
            ...
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0 font-size-18">Danh mục cấp 2
                        <a href="{{ route('be.product_category_2.add') }}" class="btn btn-primary new-custom"><i
        ...
        <div class="row">
            <div class="col-md-12">
                <div id="flink_filter" class="dataTables_filter">
                        <form action="{{ route('be.product_category_2.index') }}" method="GET">
        ...
        <div class="row">
            <div class="col-md-12">
                <table class="table text-center" id="product_category_2">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        @foreach ($data as $item)
                            <tr>
                                ...
                                <td>
                                    @include('be.component.show_edit_btn',['model'=>'product_category_2'])
                                    @include('be.component.show_delete_btn',['model'=>'product_category_2'])
                                </td>
                            </tr>
                        @endforeach
...
@endsection
@push('script')
    @include('be.component.js_model_featured',['model'=>'product_category_2'])
    @include('be.component.js_model',['model'=>'product_category_2'])
    {{-- @include('be.component.js_datatable',['model'=>'product_category_2']) --}}
@endpush
