<script type="text/javascript">
    ...
    function access_updateCharttoday() {
        ...
        fetchjson().then(datapoints => {
            ...
            truycap.data.datasets[0].label = "{{ __('Lượt truy cập') }}: " + totalvisit;
        ...
        fetchjson().then(datapoints => {
            ...
            truycap.data.datasets[1].label = "{{ __('Lượt xem trang') }} : " + totalpv;
    ...
    function access_updateChart7day() {
        ...
        fetchjson().then(datapoints => {
            ...
            truycap.data.datasets[0].label = "{{ __('Lượt truy cập') }}: "+sumvisit;
            truycap.data.datasets[0].data = visitors;
            truycap.update();
        });
        fetchjson().then(datapoints => {
            ...
            truycap.data.datasets[1].label = "{{ __('Lượt xem trang') }}: " + sumviews;
            truycap.data.datasets[1].data = pageViews;
            truycap.update();
        });
        fetchjson().then(datapoints => {
