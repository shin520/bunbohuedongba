...
@section('content')
    <div class="card-body">
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0 font-size-18">THÊM BÀI VIẾT
                    </h4>
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="{{ route('home') }}">Tổng Quan</a></li>
                            <li class="breadcrumb-item"><a href="{{ route('be.course.index') }}">Bài Viết</a></li>
        ...
        <form action="{{ route('be.course.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="row" id="create_form">
                ...
                @include('be.component.button_submit',['model'=>'course'])
            </div>
        </form>
    </div>
@endsection
