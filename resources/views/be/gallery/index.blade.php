...
@section('content')
       <div class="card-body">
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0 font-size-18">THƯ VIỆN ẢNH
                        <a href="{{ route('be.gallery.add') }}" class="btn btn-primary new-custom"><i class="fa fa-plus"></i> Thêm</a>
                    </h4>
        ...
        <div class="row">
            <div class="col-md-12">
                <table class="table text-center" id="gallery">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        @foreach ($data as $item)
                            <tr>
                                ...
                                <td>
                                    @include('be.component.show_edit_btn',['model'=>'gallery'])
                                    @include('be.component.show_delete_btn',['model'=>'gallery'])
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
