...
@section('content')
    <div class="card-body">
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0 font-size-18">THÊM SLIDE
                    </h4>
        ...
        <form action="{{ route('be.slide.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
                    ...
                    <div class="row">
                        <div class="col-md-12 mb-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="url" placeholder="Đường dẫn (Không bắt buộc)" value="{{ old('url') }}">
                            </div>
                        </div>
                        <div class="col-md-12 mb-3">
